...
public class cluster : MonoBehaviour
{
    ...
    [Range(0,10)]
    public float maxRandomForce = 5f;
    ...
    public void cohere(int n)//spring ball model - where F = kx (consider other models such as F=sinx or F=arctanx: F=force,x=extension)  
    {
        ...
        switch (n)
        {
            ...
            default:
                ...
                resultantForce = dir2cluster * clusterStiffness*Mathf.Exp(-n)*Mathf.Log(cellCount+1)*x;
    ...
    private Vector3 RandomForce()
    {
        ...
        randomForce = (randomForce + (Random.insideUnitSphere) * wanderStrength).normalized * maxRandomForce * RandomGaussian();
        return randomForce;
    }
